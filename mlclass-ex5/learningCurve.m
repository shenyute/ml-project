...
%    printf('i=%d, theta=(%d,%d) lambda=%d\n', i, theta(1), theta(2), lambda);
    [error_train(i), grad_train] = linearRegCostFunction(x_train, y_train, theta, 0);
    [error_val(i), grad_train] = linearRegCostFunction(Xval, yval, theta, 0);
%    printf('i=%d, error_train=%d, error_val=%d\n', i, error_train(i), error_val(i));
end
